...
"[project]/src/firebase/auth.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/auth.ts [app-ssr] (ecmascript)");
...
function AuthPage() {
    ...
    const handleAuth = async (e)=>{
        ...
        try {
            if (activeTab === "login") {
                const { user, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"])(email, password);
                if (error) {
                ...
                const { user, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signUp"])({
                    email,
                    password,
                    firstName,
                    lastName
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Authentication failed");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d50eed85._.js.map