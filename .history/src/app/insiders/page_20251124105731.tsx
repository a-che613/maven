      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-sm">
        <nav className="container mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2 md:gap-3">
            <Link
              href="#"
              className="px-4 md:px-6 py-2 bg-white text-black rounded-full text-xs md:text-sm font-medium hover:bg-gray-100 transition-all hover:scale-105"
            >
              FIND US
            </Link>
            <Link
          ...
          <div className="absolute left-1/2 -translate-x-1/2">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full border-2 border-[#b4aa94] flex items-center justify-center hover:border-[#d4ca94] transition-colors">
              <div className="text-[#b4aa94] font-bold text-center">
                <div className="text-xs">MVN</div>
                <div className="text-[10px]">MAVEN</div>
                <div className="text-[8px]">GENETICS</div>
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:flex gap-6 text-sm">
            <Link href="#" className="hover:text-[#b4aa94] transition-colors">
              ABOUT
            </Link>
            <Link href="#" className="hover:text-[#b4aa94] transition-colors">
              PRODUCTS
            ...
            <Link href="#" className="hover:text-[#b4aa94] transition-colors font-semibold">
              INSIDERS
            </Link>
            <Link href="#" className="hover:text-[#b4aa94] transition-colors">
              APPAREL
